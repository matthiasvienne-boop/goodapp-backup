 ...
 * is a riddle.
 */
export declare function maskeerVerbindingssnoeren(tekst: string): string;
/**
 ...
 */
export declare function maskeer(tekst: string, snoer?: string): string;
/**
 ...
 * whole object.
 */
export declare function gemaskeerdeFout(fout: unknown, snoer?: string): Error;
