...
exports.maskeerVerbindingssnoeren = maskeerVerbindingssnoeren;
exports.maskeer = maskeer;
exports.gemaskeerdeFout = gemaskeerdeFout;
 ...
 * is a riddle.
 */
function maskeerVerbindingssnoeren(tekst) {
    return tekst.replace(/\b(postgres(?:ql)?:\/\/[^:@/\s]+:)([^@\s]*)(@)/gi, (_geheel, kop, _wachtwoord, staart) => `${kop}${MASKER}${staart}`);
}
/**
 ...
 * whole object.
 */
function gemaskeerdeFout(fout, snoer) {
